...
public class DocumentInvoiceDetailsActivity extends AppCompatActivity {
...
//    boolean isRecievedInvoicesSelected;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.document_invoice_details_activity);
...
////        recyclerView.setHasFixedSize(true);
        ...
        img_arrow.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DocumentInvoiceDetailsActivity.this.finish();
            }
        });
    ...
    public void getInvoiceDetails(long id, boolean isSentInvoice) {
        ...
        Call call = invoicesService.getInvoiceDetails("Bearer " + token, id);
            ...
            public void onResponse(Call call, Response response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (data.getStatus().equals("success")) {
                        ...
                        Toast.makeText(DocumentInvoiceDetailsActivity.this, "Failed to retrieve data", Toast.LENGTH_SHORT).show();
                    }
                } else {
                    Toast.makeText(DocumentInvoiceDetailsActivity.this, "Error! Please try again!", Toast.LENGTH_SHORT).show();
                }
            }
            @Override
            public void onFailure(Call call, Throwable t) {
                loadingDialog.dismiss();
                Toast.makeText(DocumentInvoiceDetailsActivity.this, t.getMessage(), Toast.LENGTH_SHORT).show();
    ...
    private void fillInvoiceData(InvoiceDetailsData invoiceDetailsData, boolean isSentInvoice){
        Invoice invoice = invoiceDetailsData.getShipmentInvoice();
        List<Product> products = invoiceDetailsData.getProducts();
        if(isSentInvoice)
            nationalIDText.setText(invoice.getSender().getNationalId());
        else
            nationalIDText.setText(invoice.getReceiver().getNationalId());
        addressText.setText(invoice.getAddress());
        amountText.setText(invoice.getTotal());
        currencyText.setText(invoice.getCurrency().getName());
